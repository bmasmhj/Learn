        ...
        <>
         <NavLink to={`/video/${currElem.video_uri}`} className="row  p-2 video_thumbnail" >
            ...
            <div className="col-7 d-flex flex-column justify-space-between">
                ...
                <p className="p-0 pb-3 m-0 d-flex align-items-end  justify-content-between"><span> <i className="fa-duotone fa-timer"></i>{currElem.duration} Duration </span> <br/>  <span>{currElem.views} views </span></p>
            </div>
        </NavLink> 
        <hr/>
